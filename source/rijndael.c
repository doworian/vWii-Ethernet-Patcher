// rijndael AES block cipher - mike scott 1999, free use
...
void gentables(void)
{
    ...
    // power and log tables using 3 as primitive root
    ltab[0]=0;
    ptab[0]=1;  ltab[1]=0;
    ptab[1]=3;  ltab[3]=1; 
    for (i=2;i<256;i++)
